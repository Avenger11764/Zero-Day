...
- [`host_attack_story_trace.jsonl`](results/host_attack_story_trace.jsonl): Replayable 167-event stream strictly conforming to `SyscallRecord` (verified against Person A's 12-tracepoint eBPF watcher).
